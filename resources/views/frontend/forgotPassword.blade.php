                        ...
                        <form class="md-float-material" method="post" action="{{url('/forgot-password')}}" id="forgot_password">
                            ...
                            <div class="row border-secondary btn-margin">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="p-t-20">
                                            <a href="{{url('/signup-cards')}}" class="btn btn-info back-btn" id="to-recover" ><i class="fa fa-lock m-r-5"></i>Back To Login</a>
                                            <button class="btn btn-info lost_password recover-btn" type="submit">Recover</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            Copyright © <?php echo date("Y"); ?>   Mumtalikati. All rights reserved.
                        </form>
                    </div>
                    <!-- </div> -->
                </div>
