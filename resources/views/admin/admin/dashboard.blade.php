                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <div class="card-block text-center ">
                                    ...
                                    <h4 class="m-t-20"><span class="text-c-blue">570</span> Users</h4>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-block text-center">
                                    ...
                                    <h4 class="m-t-20"><span class="text-c-green">SR 730</span> Total Coupons</h4>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-block text-center">
                                    ...
                                    <h4 class="m-t-20"><span class="text-c-pink">580</span> Blogs</h4>
                        ...
                        <!-- <div class="col-lg-4 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <span class="d-block text-c-blue f-24 f-w-600 text-center">70</span>
                       ...
                       <!--  <div class="col-lg-4 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-block li_summry">
                                    
                                    <ul class="li_summry">
                                        <li>
                                            
                                           <h4>  <i class="fa fa-user text-c-blue d-inline f-30"> </i> 
                                            <span class="text-c-blue" style="display: inline-block;width: 50px;">5</span> <span style="font-weight: normal; display: inline-block;text-align: left;width:175px;">Users Added </span> </h4> 
                                        </li>
                                        <li>
                                            <h4> <i class="fa fa-file-text text-c-green d-inline f-30"></i> 
                                                <span class="text-c-green" style="display: inline-block;width: 50px;">5</span> <span style="font-weight: normal; display: inline-block;text-align: left;width:175px;">Blogs Created </span> </h4>
                                        </li>
                                        <li>
                                            <h4> <i class="fa fa-tag text-c-pink d-inline f-30"></i> 
                                                <span class="text-c-pink" style="display: inline-block;width: 50px;">5</span> <span style="font-weight: normal; display: inline-block;text-align: left;width:175px;">Coupons Created </span> </h4>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <!-- <div class="col-lg-4 col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Customder Feedback</h5>
                                </div>
                                <div class="card-block">
                                    <span class="d-block text-c-blue f-24 f-w-600 text-center">365247</span>
                                    <canvas id="feedbac-chart" height="100"></canvas>
                                    <div class="row justify-content-center m-t-15">
                                        <div class="col-auto b-r-default m-t-5 m-b-5">
                                            <h4>83%</h4>
                                            <p class="text-success m-b-0"><i class="ti-hand-point-up m-r-5"></i>Positive</p>
                                        ...
                                        <div class="tab-pane active" id="home3" role="tabpanel">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td><img src="{{url('public/assets/images/product/prod2.jpg')}}" alt="prod img" class="img-fluid"></td>
                                                        <td>PNG002344</td>
                                                        <td>John Deo</td>
                                                        <td>05-01-2017</td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{url('public/assets/images/product/prod3.jpg')}}" alt="prod img" class="img-fluid"></td>
                                                        <td>PNG002653</td>
                                                        <td>Eugine Turner</td>
                                                        <td>04-01-2017</td>
                                                    ...
                                                    <tr>
                                                        <td><img src="{{url('public/assets/images/product/prod4.jpg')}}" alt="prod img" class="img-fluid"></td>
                                                        <td>PNG002156</td>
                                        ...
                                        <div class="tab-pane" id="messages3" role="tabpanel">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td><img src="{{url('public/assets/images/product/prod1.jpg')}}" alt="prod img" class="img-fluid"></td>
                                                        <td>PNG002413</td>
                                                        <td>Jane Elliott</td>
                                                        <td>06-01-2017</td>
                        ...
                        <!-- <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <div class="card-block text-center">
                                    <i class="fa fa-edit text-c-blue d-block f-40"></i>
                                    <h4 class="m-t-20"><span class="text-c-blue">5</span> Posts</h4>
                                    <p class="m-b-20">Your Posts list is growing</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-block text-center">
                                    ...
                                    <h4 class="m-t-20"><span class="text-c-green">5</span> Groups</h4>
                                    <p class="m-b-20">Your Groups list is growing</p>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-block text-center">
                                    <i class="fa fa-university text-c-pink d-block f-40"></i>
                                    <h4 class="m-t-20"><span class="text-c-pink">5</span> School/Universities</h4>
                                    <p class="m-b-20">Your University list is growing</p>
                            ...
                            <div class="card user-card">
                                ...
                                <div class="card-block">
                                    <div class="usre-image">
                                        <img src="{{url('public/assets/images/avatar-4.jpg')}}" class="img-radius" alt="User-Profile-Image">
                                    </div>
                                    ...
                                    <ul class="feed-blog">
                                        <li class="active-feed">
                                            <div class="feed-user-img">
                                                <img src="{{url('public/assets/images/avatar-3.jpg')}}" class="img-radius " alt="User-Profile-Image">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-auto text-center">
                                                    <img src="{{url('public/assets/images/blog/blog-r-1.jpg')}}" alt="img" class="img-fluid img-100">
                                                    <h6 class="m-t-15 m-b-0">Old Scooter</h6>
                                                    <p class="text-muted m-b-0"><small>PNG-100KB</small></p>
                                                </div>
                                                <div class="col-auto text-center">
                                                    <img src="{{url('public/assets/images/blog/blog-r-2.jpg')}}" alt="img" class="img-fluid img-100">
                                                    <h6 class="m-t-15 m-b-0">Wall Art</h6>
                                                    <p class="text-muted m-b-0"><small>PNG-150KB</small></p>
                                                </div>
                                                <div class="col-auto text-center">
                                                    <img src="{{url('public/assets/images/blog/blog-r-3.jpg')}}" alt="img" class="img-fluid img-100">
                                        ...
                                        <li class="diactive-feed">
                                            <div class="feed-user-img">
                                                <img src="{{url('public/assets/images/avatar-2.jpg')}}" class="img-radius " alt="User-Profile-Image">
                                            </div>
